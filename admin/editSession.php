<?php
	...
	if(isset($_POST['submit'])){
		...
		if ($query === TRUE) {
			...
			$statusMsg="School Year Edited Successfully!";
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header"  style="background:rgb(69,69,69);color:white;">
									<strong class="card-title"><h2 align="center">Edit School Year</h2></strong>
								</div>
								<div class="card-body">
									<!-- Credit Card -->
									<div id="pay-invoice">
											...
											<form method="Post" action="">
												<div class="row">
													<div class="col-6">
														...
														<div>
													<button type="submit" name="submit" class="btn btn-primary">Update School Year</button>
												</div>
											</form>
										</div>
									</div>
