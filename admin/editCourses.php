<?php
	...
	if(isset($_POST['submit'])){
		...
		if ($query) {
			...
			header("Location:editCourses.php?statusMsg=".$statusMsg);
			exit();
		}
	}
?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="viewCourses.php">Subjects</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style="background:rgb(69,69,69);color:white;" >
                                <strong class="card-title"><h2 align="center">Update Subject</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="courseTitle" type="text" class="form-control cc-exp" value="<?php echo $rowi['courseTitle'];?>" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Subject Title">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Subject Code</label>
                                                        <input id="" name="courseCode" type="text" class="form-control cc-exp" value="<?php echo $rowi['courseCode'];?>" Required placeholder="Subject Code">
                                                ...
                                                <div class="row">
													<div class="col-6">
														<div class="form-group">
															...
															<input id="" name="courseUnit" type="text" class="form-control cc-exp" value="<?php echo $rowi['courseUnit'];?>" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Subject Unit">
														</div>
													</div>
													<div class="col-6">
														<div class="form-group">
